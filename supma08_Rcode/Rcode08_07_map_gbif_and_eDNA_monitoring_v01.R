...
df_iN01$dec_lat <- as.numeric(df_iN01$lat)
df_iN01$dec_lon <- as.numeric(df_iN01$lon)
#make positions numeric
...
df_iN01$eval03 <- "gbif"
df_iN01$eval04 <- df_iN01$eval03
df_iN01$eval04[df_iN01$datasetName=="iNaturalist research-grade observations"] <- "iNat_res"
#subset to exclude iNaturalist records
#df_iN01 <- df_iN01[!df_iN01$datasetName=="iNaturalist research-grade observations" ,]
...
df_iNDL02$monit.cat[df_iNDL02$eval03=="gbif"] <- "gbif"

df_iNDL02$monit.cat[df_iNDL02$eval04=="eDNA_zero"] <- "eDNA_monit"
df_iNDL02$monit.cat[df_iNDL02$eval04=="eDNA_present"] <- "eDNA_monit"
df_iNDL02$monit.cat[df_iNDL02$eval04=="iNat_Res"] <- "iNat_Res"
df_iNDL02$monit.cat[df_iNDL02$eval04=="gbif"] <- "gbif"
...
# fgnm <- paste0("Fig04_v01_",infl1,".pdf")
...
# infl1 <- gsub(".csv","",infl1)
# #define file name to save plot to
# fgnm <- paste0("Fig04_v02_",infl1,".pdf")
# #paste the path and the file name together
# pfnm <- paste0(wd00_wd09,"/",fgnm)
# # save plot
# if(bSaveFigures==T){
...
# infl1 <- gsub(".csv","",infl1)
# #define file name to save plot to
# fgnm <- paste0("Fig04_v03_",infl1,".pdf")
# #paste the path and the file name together
# pfnm <- paste0(wd00_wd09,"/",fgnm)
# # save plot
# if(bSaveFigures==T){
...
#df_mcat <- as.data.frame(cbind(unique(df_iNDL04$eval04), c(3,4,2,1)))
