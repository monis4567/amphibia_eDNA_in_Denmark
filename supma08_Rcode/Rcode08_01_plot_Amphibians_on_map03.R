...
spl3.Lf <- spl3[grepl("Loev",spl3$specs),]
...
spl3.Lf <- spl3[grepl("Loev",spl3$specs),]
spl3.Lf <- spl3.Lf[spl3.Lf$NPC.CtdRn>0,]
spl3.Lf <- spl3.Lf[spl3.Lf$NTC.CtdRn==0,]
#nrow(spl3.Lf)
# subset to disregard any Cq values above ct.cutoff
...
tibl_as02.Rt <- tibl_as02[grepl("tem",tibl_as02$abbr.nm),]
