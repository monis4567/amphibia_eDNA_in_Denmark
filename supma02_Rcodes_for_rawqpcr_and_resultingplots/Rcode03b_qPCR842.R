...
ls.fl01.xls<- ls.fl01.xls[grep("842", ls.fl01.xls)]
...
prim1 <- c("cytb_F01", "cytb_R01", "cytb_P01")
# prim2 <- c("co1_F12", "co1_R12", "co1_P12")
# prim3 <- c("NA", "NA", "NA")
# prim4 <- c("NA", "NA", "NA")
# prim5 <- c("NA", "NA", "NA")
# prim6 <- c("NA", "NA", "NA")
...
incsvfl2 <- incsvfl[grepl("842",incsvfl)]
