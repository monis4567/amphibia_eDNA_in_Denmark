...
ls.fl01.xls<- ls.fl01.xls[grep("890", ls.fl01.xls)]
...
prim1 <- c("Lisvul_F01", "Lisvul_R01", "Lisvul_P01")
...
well.splt02 <- data.frame(do.call('rbind', strsplit(as.character(well.splt01$X2),'_',fixed=TRUE)))
well.splt03 <- data.frame(do.call('rbind', strsplit(as.character(well.splt01$X2),'_',fixed=TRUE)))
#head(well.splt01)
#head(well.splt03)
